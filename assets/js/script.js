...
function generatePassword() {
    ...
    if (includeSpecialChars) chosenCharacters = [...chosenCharacters, ...specialCharacters]
    
    var includeUpperChars = confirm("Would you like to include uppercase characters");
    if (includeUpperChars) chosenCharacters = [...chosenCharacters, ...upperCasedCharacters]

    var includeLowerChars = confirm("Would you like to include lowercase characters");
    if (includeLowerChars) chosenCharacters = [...chosenCharacters, ...lowerCasedCharacters]

    var includeNumberChars = confirm("Would you like to include numeric characters");
    if (includeNumberChars) chosenCharacters = [...chosenCharacters, ...numericCharacters]
